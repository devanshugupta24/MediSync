...
/*
    <div className='flex flex-col md:flex-row items-center justify-end  bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        { ------Right Side-------- }
        <div className='md:w-2/5 h-28 flex flex-col items-center rounded-lg relative'>
            <p className='hidden md:block text-white w-2/3 break-words p-3  rounded-md'>
                esiuvnheskeddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddsuhsnhevoeshvionhdxjnhvfdxjvhxl...<button onClick={()=>{navigate(`/about`); scrollTo(0,0)}}className=' text-gray-900 rounded-full hover:scale-105 transition all duration-300'>more</button>
            </p>
        </div>
    </div>
*/
